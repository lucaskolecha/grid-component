  ...
  function controller($scope, $element, $attrs, $timeout, $sce) {
    ...
    function guaranteeColumns() {
      ...
      return columns.split(',').map(function (rawColumn) {
        ...
        return { searchPlaceholder: searchPlaceholder, title: title, size: size, name: name, content: content, sortField: sortField, conditional: conditional, editable: editable, possibleColumn: possibleColumn, label: label, alignColumn: alignColumn, alignRows: alignRows, widthPorcentage: widthPorcentage, activeSearch: activeSearch };
      });
    }
